...
import static com.github.bartoszpop.gait.command.TestNG.asSuite;
...
public final class CommandFacadeTest {
    ...
    void redo_redoStrategyApplies_commandSupplierRedone() {
        ...
        // then
        assertThat(resultCommand, CommandMatchers.redone());
    }
    ...
    void redo_undoStrategyApplies_commandUndone() {
        ...
        // then
        assertThat(command.undo(), CommandMatchers.redone());
    }
