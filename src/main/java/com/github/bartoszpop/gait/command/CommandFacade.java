...
import static com.github.bartoszpop.gait.command.CommandFacade.StrategyLazyHolder.getRedoStrategy;
import static com.github.bartoszpop.gait.command.CommandFacade.StrategyLazyHolder.getUndoStrategy;
import static com.github.bartoszpop.gait.command.CommandListener.getCurrentContext;
import static com.github.bartoszpop.gait.command.RedoStrategy.redoable;
...
public final class CommandFacade {
    ...
    private void redoOnUndo(Command undoCommand) {
        if ( false == Command.NO_OP.equals(undoCommand) ) {
